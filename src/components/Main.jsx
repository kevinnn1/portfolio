  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="relative w-full md:w-[800px] md:h-screen">
        <img className="w-full h-full object-cover object-left" src="./bg.jpg" alt="Background" />

        <div className="absolute top-0 left-0 w-full h-full bg-white/20 dark:bg-black/50">
      
          <div className="max-w-[1440px] m-auto h-full p-4 flex justify-center items-center">
      ...
      <div className=" flex flex-col  gap-8  mt-4 md:mt-0 m-4 md:items-start items-center">
