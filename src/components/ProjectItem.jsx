...
export const ProjectItem = ({ img, title, description, link }) => {
  return (
    <div className="flex h-72 sm:h-96 max-w-[1040px] lg:w-full items-center justify-center  shadow-xl shadow-gray-600 dark:shadow-gray-900 rounded-xl group hover:bg-white dark:bg-black transform hover:-translate-y-4 transition ">
      <img src={img} alt="" className="h-full w-full rounded-xl group-hover:opacity-40"/>
